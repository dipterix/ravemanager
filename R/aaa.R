...
rave_suggests <- c("SparseM", "Rvcg", "visNetwork", "clustermq", "quantreg", "mvtnorm", "nloptr", "minqa", "lme4", "circular", "learnr", "RcppEigen", "zoo", "lmtest", "distill", "shinychat", "ellmer", "btw", "BH", "RcppDate", "RcppTOML",
                   "RcppArmadillo", "quarto", "httr", "plotly")
